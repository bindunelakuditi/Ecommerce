        ...
        return(
            <div className='full-height'>
                <div className='header'>
                    <label style={HS1}> | E-COMMERCE PRODUCT SEARCH AND PRICE COMPARABILITY</label>
                ...
                <div className='content'>
                    ...
                    <div className='outlet'>
                        <div id='titlebar'></div>
                        <iframe id='module' src="" title="Module Content"></iframe>

                    </div>
                </div>
                <div className='footer'>
                    Copyright @ E-COMMERCE. All rights reserved.
                </div>
            </div>
        );
    }
